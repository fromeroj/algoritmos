...
El algoritmo visto en clase es el siguiente:
Asumiendo que el carro puede andar $n$ km con el tanque lleno, se revisa cual es la gasolinera más lejana que esta a menos de $n$ km y se llena el tanque en esta gasolinería y se repite el proceso.
